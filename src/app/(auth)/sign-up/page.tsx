    ...
    <main className="flex min-h-screen w-full">
      <section className="flex-1 bg-white flex p-2 items-center justify-center relative overflow-hidden">
        ...
        <div className="bg-white rounded-lg w-full max-w-md mx-auto animate-fadeIn">
          ...
          <p className="text-sm font-normal text-gray-400 gray-100 mb-10">Welcome! Please Enter these details to regsiter.</p>
          <form>
            <div className="mb-6">
            ...
            <div className="mb-2.5">
              ...
              <input type="name" placeholder="Name" className="w-full px-3 py-2 border rounded" />
            </div>
            <div className="mb-2.5">
              <label className="block font-semibold text-base text-gray-500 mb-2.5">Role</label>
              <input type="select" placeholder="Role" className="w-full px-3 py-2 border rounded" />
            </div>
